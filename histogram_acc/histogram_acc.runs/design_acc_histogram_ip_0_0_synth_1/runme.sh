...
HD_PWD='D:/AGH/Semestr_VIII/SDUP/Projekt/Project/histogram_acc/histogram_acc.runs/design_acc_histogram_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_acc_histogram_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_acc_histogram_ip_0_0.tcl
