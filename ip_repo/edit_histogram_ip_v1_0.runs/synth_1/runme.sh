...
HD_PWD='d:/agh/semestr_viii/sdup/projekt/project/ip_repo/edit_histogram_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histogram_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histogram_ip_v1_0.tcl
